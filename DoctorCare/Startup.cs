...
namespace DoctorCare
{
    ...
    options.SerializerSettings.ReferenceLoopHandling = Newtonsoft.Json.ReferenceLoopHandling.Ignore);
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DoctorCare", Version = "v1" });
            });
            ...
            services.AddScoped<IValidator<AppointmentCreate>, AppointmentCreateValidator>();
            services.AddScoped<IValidator<UpdateUserDto>, UpdateUserValidator>();
            services.AddScoped<IAuthorizationHandler, ProfileHandler>();
            services.AddScoped<IAuthorizationHandler, AppointmentDataHandler>();
            services.AddScoped<IAuthorizationHandler, AppointmentAllowedHandler>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "DoctorCare v1"));
